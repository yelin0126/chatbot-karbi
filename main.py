...
# FastAPI
# =========================
app = FastAPI(title="Tilron AI Chatbot API", version="6.1.0")
...
def extract_text_with_marker(pdf_path: str) -> str:
    ...
    try:
        ...
        print(f"[marker error] {e.stderr}")
        return ""
    except FileNotFoundError:
        print("[marker error] marker_single 명령어를 찾을 수 없습니다.")
        return ""
